...
$(function () {
    var t = $("#table").DataTable({
        processing: true,
        serverSide: true,
        ajax: '{{ route('kelurahan.ajaxDatatable') }}',
        columns: [
            { data: "rownum", searchable: false, width: "10%", className: 'text-center' },
            { data: "nama_kecamatan", name: "nama_kecamatan" },
            { data: "nama_kelurahan", name: "kelurahan.nama_kelurahan" },
            { data: "created_at", name: "kelurahan.created_at", className: 'text-center' },
            { data: "updated_at", name: "kelurahan.updated_at", className: 'text-center' },
