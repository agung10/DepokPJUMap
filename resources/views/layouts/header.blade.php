        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="javascript:;" class="d-lg-none">
                <div class="d-flex flex-center">
                    <img alt="Logo" src="assets/admin/media/logos/logo.png" class="h-25px" style="margin-right: 10px;"/>
                    <h1 class="text-muted" style="font-size: 17px; padding-top: 10px;">Depok<span style="color: #4B56D2;">PJUMAP</span></h1>
                </div>
            </a>
        </div>
        <!--end::Mobile logo-->
            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        <img src="assets/admin/media/avatars/blank.png" alt="user" />
                    </div>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <img alt="Logo" src="assets/admin/media/avatars/blank.png" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Username-->
                        ...
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
                            <a href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();" class="menu-link px-5">Keluar</a>
